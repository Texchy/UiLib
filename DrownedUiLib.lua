...
local themes = {
	...
	Drowned = {
		...
		["Window Background"] = Color3.fromRGB(26, 26, 26),
		["Window Border"] = Color3.fromRGB(41, 41, 41),
		["Tab Background"] = Color3.fromRGB(41, 41, 41),
		["Tab Border"] = Color3.fromRGB(166, 74, 255),
		["Tab Toggle Background"] = Color3.fromRGB(41, 41, 41),
		["Section Background"] = Color3.fromRGB(41, 41, 41),
		["Section Border"] = Color3.fromRGB(64, 64, 64),
		["Text"] = Color3.fromRGB(255, 255, 255),
		["Disabled Text"] = Color3.fromRGB(224, 224, 224),
		["Object Background"] = Color3.fromRGB(41, 41, 41),
		["Object Border"] = Color3.fromRGB(41, 41, 41),
		["Dropdown Option Background"] = Color3.fromRGB(41, 41, 41)
	}
}

local themeobjects = {}

local library = utility.table({theme = table.clone(themes.Drowned), folder = "Drowned Hub", extension = "cfg", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "Drowned"}
...
function library:Load(options)
	...
	local name = "Drowned Hub"
	local sizeX = options.sizex or 450
	local sizeY = options.sizey or 500
	local theme = options.theme and options.theme or "Midnight"
...
-- Edited by Exunys for Drowned V2
